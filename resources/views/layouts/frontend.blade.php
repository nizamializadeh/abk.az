                ...
                <div class="modal-body">
                    <form  action="/call" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer" style="border: none;">
                            ...
                            <input style="background-color: #F28F00"  class="btn btn-secondary" type="submit" value="Zənginizi gözləyirəm">
                    ...
                    <div class="header-column">
                        <div class="header-row">
                            <div class="header-logo">
                                <a href="{{ url('/') }}">
                                    <img alt="abk.az" width="145" height="82" data-sticky-width="82" data-sticky-height="40" src="{{asset('frontend/img/amazon.png')}}" alt="Banner">
...
<footer id="footer" class="mt-0">
    <div class="container my-4">
        <div class="row py-5">
            <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                <h5 class="text-5 text-transform-none font-weight-semibold text-color-light mb-4">Əlaqə</h5>
            ...
            <div class="col-6 col-lg-2 mb-5 mb-lg-0">
                <h5 class="text-5 text-transform-none font-weight-semibold text-color-light mb-4">Səhifə</h5>
            ...
            <div class="col-6 col-lg-2 mb-5 mb-lg-0">
                <h5 class="text-5 text-transform-none font-weight-semibold text-color-light mb-4">Sosial</h5>
                <ul class="list list-icons list-icons-sm">
    ...
    bottom: 54px;color: green" class="fixed-bottoms">
        <a style="color: green"  target="_blank"  href="https://wa.me/{{$number->number}}">
